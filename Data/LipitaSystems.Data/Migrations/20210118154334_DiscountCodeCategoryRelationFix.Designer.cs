...
namespace LipitaSystems.Data.Migrations
{
    ...
    [Migration("20210118154334_DiscountCodeCategoryRelationFix")]
    partial class DiscountCodeCategoryRelationFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiscountCodeSecondaryCategory", b =>
                {
                    b.Property<int>("DiscountCodesId")
                        .HasColumnType("int");

                    b.Property<int>("SecondaryCategoriesId")
                        .HasColumnType("int");

                    b.HasKey("DiscountCodesId", "SecondaryCategoriesId");

                    b.HasIndex("SecondaryCategoriesId");

                    b.ToTable("DiscountCodeSecondaryCategory");
                });
            ...
            modelBuilder.Entity("LipitaSystems.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("LipitaSystems.Data.Models.ContactMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LipitaSystems.Data.Models.DiscountCode", b =>
                {
                    ...
                    b.Property<bool>("DoesWorkOnDiscountedProducts")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LipitaSystems.Data.Models.News", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LipitaSystems.Data.Models.ProductOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DiscountCodeSecondaryCategory", b =>
                {
                    ...
                    b.HasOne("LipitaSystems.Data.Models.SecondaryCategory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LipitaSystems.Data.Models.ProductOrder", b =>
                {
                    b.HasOne("LipitaSystems.Data.Models.Order", "Order")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("LipitaSystems.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LipitaSystems.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
